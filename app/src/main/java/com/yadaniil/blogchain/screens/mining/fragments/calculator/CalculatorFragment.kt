...
//        hour_rewards.coinName = "${(dayReward / HOURS_IN_DAY)}"
...
//        month_rewards.coinName = "${(dayReward * DAYS_IN_MONTH)}"
...
//        year_rewards.coinName = "${(dayReward * DAYS_IN_YEAR)}"
